        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-md p-6 sm:p-8 shadow-2xl relative">
            ...
            <p className="text-xs text-slate-300 mb-4 leading-relaxed">
              Ingresa tu correo institucional de Google (<span className="text-teal-400 font-mono">@utem.cl</span>) con el que tienes tu sesión activa para verificar tu membresía en el equipo:
            </p>
